    ...
    <section className="relative pt-32 sm:pt-40 pb-16 sm:pb-24 bg-[#0A0A0A] overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
          <span className="badge-accent mb-5 sm:mb-6">Our Story</span>
          ...
          <p className="text-white/50 text-sm sm:text-base lg:text-lg max-w-2xl mx-auto leading-relaxed mb-6 sm:mb-8">
