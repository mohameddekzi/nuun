...
export interface Database {
  public: {
    Tables: {
      ...
      quotations: {
        Row: { id: string; quote_number: string; status: string; type: string; client_name: string; client_email: string | null; client_phone: string | null; client_company: string | null; client_address: string | null; issue_date: string; due_date: string | null; currency: string; discount_type: string; discount_value: number; tax_rate: number; notes: string | null; terms: string | null; footer_text: string | null; created_by: string | null; created_at: string; updated_at: string; paid_at: string | null; total_amount: number | null };
        Insert: { id?: string; quote_number?: string; status?: string; type?: string; client_name?: string; client_email?: string | null; client_phone?: string | null; client_company?: string | null; client_address?: string | null; issue_date?: string; due_date?: string | null; currency?: string; discount_type?: string; discount_value?: number; tax_rate?: number; notes?: string | null; terms?: string | null; footer_text?: string | null; created_by?: string | null; paid_at?: string | null; total_amount?: number | null };
        Update: { quote_number?: string; status?: string; type?: string; client_name?: string; client_email?: string | null; client_phone?: string | null; client_company?: string | null; client_address?: string | null; issue_date?: string; due_date?: string | null; currency?: string; discount_type?: string; discount_value?: number; tax_rate?: number; notes?: string | null; terms?: string | null; footer_text?: string | null; paid_at?: string | null; total_amount?: number | null };
      };
      quotation_items: {
